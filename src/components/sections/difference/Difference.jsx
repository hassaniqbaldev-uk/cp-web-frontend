        ...
        <div className="relative z-[10] container">
          <div className="flex flex-col items-center justify-center gap-[2rem] md:gap-[5rem]">
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
              className="mt-[3rem] flex w-full flex-col items-center gap-[5rem]"
            >
              <motion.div
                variants={itemVariants}
                className="flex items-center justify-center gap-[2rem] text-[2.8rem] leading-[3.5rem] font-semibold tracking-[-0.02em] text-white md:gap-[4rem] md:text-[3.4rem] md:leading-[4.8rem]"
              >
                <span>With</span>
                <Switch
                  checked={!isWith}
